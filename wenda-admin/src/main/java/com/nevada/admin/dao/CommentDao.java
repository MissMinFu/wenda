...
public interface CommentDao {
    ...
    @Select({"select",SELECT_FIELDS,"from",TABLE_NAME,"where entity_id=#{entityId}  order by created_date desc" })
    Comment selectCommentByEntity(@Param("entityId") int entityId);
